(function() {
    ...
    var u_class = '.gt_container-' + Array.from('dropdown' + wrapper_selector).reduce(function(h, c) {
    ...
    document.querySelectorAll(u_class + ' .gt_selector').forEach(function(e) {
        e.addEventListener('change', function(evt) {
            if (url_structure == 'none')
                ...
                evt.target.querySelectorAll('option[value="' + evt.target.value + '"][data-gt-href]').forEach(function(e) {
    ...
    if (detect_browser_language && window.sessionStorage && window.navigator && sessionStorage.getItem('gt_autoswitch') == null && !/bot|spider|slurp|facebook/i.test(navigator.userAgent)) {
        ...
        if (current_lang == default_language && preferred_language != default_language && languages.includes(preferred_language)) {
            if (url_structure == 'none') {
                ...
                document.querySelectorAll(u_class + ' .gt_selector option[value="' + default_language + '|' + preferred_language + '"][data-gt-href]').forEach(function(e) {
                    location.href = e.getAttribute('data-gt-href')
                });
        }
